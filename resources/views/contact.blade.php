...
<section class="py-16 bg-white">
    <div class="max-w-screen-xl px-4 mx-auto sm:px-6 lg:px-8">
        ...
        <div class="p-5 bg-gray-900 grid grid-cols-1 gap-12 mt-12 md:grid-cols-2">
            <!-- Contact Information -->
            <div class="space-y-10">
                ...
                <div>
                    ...
                    <p class="mt-2 text-white">
                        Phone: <a href="tel:+62234567890" class="text-yellow-100 hover:underline">+62 234 567 890</a><br>
                        Email: <a href="mailto:coffee@lhaikicafe.com" class="text-yellow-100 hover:underline">coffee@lhaikicafe.com</a>
                    </p>
                </div>
                <div>
                    <h3 class="text-lg font-semibold text-yellow-400">
